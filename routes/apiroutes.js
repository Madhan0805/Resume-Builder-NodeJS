...
// resume
router.get("/get-resume", Resume.userGetCreatedResume);
router.post("/create-resume", Resume.createNewResume);
router.post("/user-created-resume", Resume.userCreatedResume);
